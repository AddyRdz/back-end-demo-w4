...
OpenID connect - deals with Authentication (.sign) - used to enable user logins on websites and mobile apps
Oauth - deals with Authorization - (like, verify) granting access without having to lon in on the site itself.

OIDC - implements in the web apps, it (like 3rd party services like Auth0), can both simplify the user's life and our lives as developers, and also increases security of our application
...
OIDC Token Usage
-- access tokesn -> tells our API that the user has been authorized access
...
// BEFORE!!
// const {
//   AUTH0_SECRET = 'Cc5eKuEtkHEAaUJzMmjmVBen34lUzkwlCXTM8DwBrgs', 
...
const config = {
  authRequired: false, //can be set to true
...
app.use(auth(config)) // this is when were initializing our connection to OpenID Connect
